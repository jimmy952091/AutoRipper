...
Write-Host "MSI written to $out\AutoRipper-0.1.0-x64.msi"
Write-Host "Silent install:   msiexec /i AutoRipper-0.1.0-x64.msi /qn"
Write-Host "Silent uninstall: msiexec /x AutoRipper-0.1.0-x64.msi /qn"
